 ...
 * Slug: dolkelochdesign/storm-steps
...
<div class="wp-block-group alignfull do-sec-steps" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:heading {"align":"wide"} -->
...
<div class="wp-block-group"><!-- wp:paragraph {"className":"do-step-num"} -->
<p class="do-step-num"><?php echo (int) $i + 1; ?></p>
<!-- /wp:paragraph -->
